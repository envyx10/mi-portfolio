  ...
  return (
    <div className="fixed left-[2%] sm:left-[3%] md:left-[4%] xl:left-[6%] 2xl:left-[8%] top-1/2 -translate-y-1/2 z-50 hidden md:block">
      <div ref={sidebarRef} className="flex flex-col items-center opacity-0 translate-y-[30px] transition-all duration-1000 ease-out">
        ...
        <div className="w-px h-[30vh] sm:h-[35vh] md:h-[38vh] lg:h-[40vh] bg-gradient-to-b from-transparent via-gray-500/40 to-gray-500/60"></div>
        ...
        <div className="w-px h-[30vh] sm:h-[35vh] md:h-[38vh] lg:h-[40vh] bg-gradient-to-b from-gray-500/60 via-gray-600/40 to-transparent"></div>
      </div>
    </div>
  );
}
